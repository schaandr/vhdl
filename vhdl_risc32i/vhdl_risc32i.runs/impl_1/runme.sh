...
HD_PWD='C:/Users/andsc/vhdl_risc32i/vhdl_risc32i.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RV32I_CPU_ALU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RV32I_CPU_ALU.tcl -notrace
