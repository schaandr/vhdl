...
HD_PWD='C:/Users/andsc/vhdl_risc32i/vhdl_risc32i.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RV32I_CPU_ALU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RV32I_CPU_ALU.tcl
